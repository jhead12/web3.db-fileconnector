...
export default function Settings() {
  ...
  const [settings, setSettings] = useState({
    ...
    ceramic: {
      ...
      settingsStreamId:
        process.env.NEXT_PUBLIC_CERAMIC_SETTINGS_STREAM_ID || "",
    },
    composeDb: {
        ...
        setSettings((prev) => {
          ...
          return {
            ...
            ceramic: {
              ...ceramicData,
              settingsStreamId:
                data.settingsStreamId || ceramicData.settingsStreamId,
            },
            composeDb: {
              ...composeDbData,
              modelId:
                data.updatedSettings?.composeDb?.modelId ||
                composeDbData.modelId,
            },
          };
        });
        setSuccess(true);
          ...
          {settings.ipfs?.enabled && (
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("ipfs", "nodeUrl", e.target.value)
                }
            ...
            <>
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("ceramic", "nodeUrl", e.target.value)
                  }
                  className="w-full p-2 border rounded"
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("ceramic", "adminSeed", e.target.value)
                  }
                  className="w-full p-2 border rounded"
                  placeholder="Admin seed in hex format"
                />
                <p className="text-sm text-gray-500 mt-1">
                  This is used to authenticate with the Ceramic node. Keep this
                  secure.
                </p>
              </div>
            ...
            <>
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("composeDb", "schemaId", e.target.value)
                  }
                  className="w-full p-2 border rounded"
