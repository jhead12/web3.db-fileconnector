...
export default class ERC20Interface {
  decimals;
  symbol;
  name;
  address;
  ...
  constructor(address, rpcUrl) {
    ...
    // Initialize contract
    this.contract = new this.web3.eth.Contract(erc20ABi, address);
  ...
  parse(event) {
    ...
    switch (event.event) {
      case "Transfer":
        model_id =
          "kjzl6hvfrbw6c6t3290d1fhjfgbhbxk6swjke201jnxlg2igxewtxk6epclxc99";
        content = {
          type: "Transfer",
          ...
          value: parseFloat(this.formatValue(event.returnValues.value)),
      ...
      case "Mint":
        ...
        content = {
          ...
          to: event.returnValues.to,
          value: parseFloat(this.formatValue(event.returnValues.amount)),
          decimals: this.decimals || 18,
          symbol: this.symbol || "",
          name: this.name || "",
        };
